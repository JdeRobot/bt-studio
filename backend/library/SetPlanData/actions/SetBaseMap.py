...
class SetBaseMap(py_trees.behaviour.Behaviour):
    ...
    def setup(self, **kwargs: int) -> None:
        ...
        self.mapImg = plt.imread("/resources/exercises/amazon_warehouse/images/map.png")
    ...
    def update(self) -> py_trees.common.Status:
        ...
        tree_tools.set_port_content(self.ports["map"], self.mapImg)
