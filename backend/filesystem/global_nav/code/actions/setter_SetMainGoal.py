...
class setter_SetMainGoal(py_trees.behaviour.Behaviour):
    ...
    def update(self) -> py_trees.common.Status:
        ...
        tree_tools.set_port_content(self.ports["x"], -93)
        tree_tools.set_port_content(self.ports["y"], 211)
        tree_tools.set_port_content(self.ports["yaw"], 0)
