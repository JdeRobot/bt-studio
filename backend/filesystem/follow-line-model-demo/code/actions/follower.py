...
class follower(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, name, ports=None):
        ...
        try:
            ...
            posibles_rutas = [
                ...
                os.path.join(
                    dir_path, "actions", "follow-line-imitation-master-model-v1.onnx"
                ),
            ...
            if ruta_modelo is None:
                raise FileNotFoundError(
                    f"No se pudo encontrar el archivo .onnx en ninguna de las rutas: {posibles_rutas}"
                )

            self.session = onnxruntime.InferenceSession(
                ruta_modelo, providers=["CUDAExecutionProvider", "CPUExecutionProvider"]
            )
    ...
    def update(self) -> py_trees.common.Status:
        ...
        try:
            ...
            if (
                pixeles_rojos < 100
            ):  # Puedes ajustar este umbral (100) si es muy sensible
