...
class SetMainGoal(py_trees.behaviour.Behaviour):
    ...
    def update(self) -> py_trees.common.Status:
        ...
        tree_tools.set_port_content(self.ports["x"], 3.73)
        tree_tools.set_port_content(self.ports["y"], 0.57)
        tree_tools.set_port_content(self.ports["yaw"], math.pi / 2)
