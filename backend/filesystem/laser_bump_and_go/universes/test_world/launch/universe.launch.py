...
def generate_launch_description():
    ...
    gazebo_custom_models_path = os.path.join("/workspace/worlds/install/test_world/share/test_world/", "models")

    # robot_launch_dir = os.path.join(custom_dir, "launch/universe.launch.py")
    world_path = os.path.join("/workspace/worlds/install/test_world/share/test_world/", "worlds/universe.world")
    ...
    ld.add_action(SetEnvironmentVariable('GZ_SIM_RESOURCE_PATH', gazebo_predefined_models_path))
    ld.add_action(AppendEnvironmentVariable('GZ_SIM_RESOURCE_PATH', gazebo_custom_models_path))
