...
def main():
    ...
    demo_share_dir = get_package_share_directory('offline_executor')
    demo_root_dir = get_package_prefix('offline_executor')
    ...
    src_resource_dir = os.path.join(demo_root_dir, '..', '..', 'src', 'offline_executor', 'resource')
